export const humanRequestMessages = {
  en: {
    ...
    mayExpire: 'The Action keeps its original deadline and may expire before password confirmation is completed.',
  ...
  pt: {
    ...
    mayExpire: 'O Action mantém o prazo original e pode expirar antes da confirmação da senha.',
