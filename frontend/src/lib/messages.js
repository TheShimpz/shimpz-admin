...
export const messages = {
  en: {
    ...
    auth: {
      checking: 'Checking…',
      heroTitle: 'Your world, one Capsule at a time.',
      heroLead: 'A calm control plane for isolated apps, shared Drivers, and the ideas you want to ship next.',
      ...
      capsuleIsolation: 'Capsule isolation',
    ...
    workspace: {
      ...
      title: 'Integrations',
      lead: 'Connect and configure the Space-wide services your Capsules can build on.',
      capsulesKicker: 'Capsules',
      capsulesTitle: 'Build isolated worlds',
      capsulesLead: 'Install apps and scoped credentials without crossing Capsule boundaries.',
      openCapsules: 'Open Capsules',
      empty: 'No integrations are available in this category.',
    },
    capsules: {
      kicker: 'Capsules // isolated runtimes',
      title: 'Capsules',
      lead: 'Each Capsule is a private world for apps, credentials, data, and the work they create together.',
      create: 'New Capsule',
      createTitle: 'Create a Capsule',
      createLead: 'Start with an empty isolated runtime. You can install apps and scoped Driver credentials next.',
      name: 'Capsule name',
      placeholder: 'e.g. studio-lab',
      createAction: 'Create Capsule',
      creating: 'Creating…',
      cancel: 'Cancel',
      ...
      emptyLead: 'Create an empty Capsule, then make it yours with apps and scoped Driver access.',
      needAuthTitle: 'Captain access required',
      needAuthLead: 'Sign in to the local Admin before managing Capsules.',
      signIn: 'Open sign-in',
      status: 'Runtime',
      identifier: 'Capsule ID',
      drivers: 'Scoped Drivers',
      driversLead: 'Optional credentials that belong only to this Capsule.',
      destroy: 'Destroy',
      destroyTitle: 'Destroy this Capsule?',
      destroyLead: 'This permanently removes its data, database, network, apps, and scoped credentials.',
      destroying: 'Destroying…',
    },
    store: {
      nav: 'Assistants',
      kicker: 'Assistant Store // canonical',
      title: 'One Store. Every Capsule.',
  ...
  pt: {
    ...
    auth: {
      ...
      heroTitle: 'Seu mundo, uma Cápsula de cada vez.',
      heroLead: 'Um plano de controle confortável para apps isolados, Drivers compartilhados e as próximas ideias que você quer lançar.',
      ...
      capsuleIsolation: 'Isolamento por Cápsula',
    ...
    workspace: {
      ...
      title: 'Integrações',
      lead: 'Conecte e configure os serviços globais do Space que suas Cápsulas podem utilizar.',
      capsulesKicker: 'Cápsulas',
      capsulesTitle: 'Construa mundos isolados',
      capsulesLead: 'Instale apps e credenciais dedicadas sem cruzar os limites de cada Cápsula.',
      openCapsules: 'Abrir Cápsulas',
      empty: 'Nenhuma integração está disponível nesta categoria.',
    },
    capsules: {
      kicker: 'Cápsulas // runtimes isolados',
      title: 'Cápsulas',
      lead: 'Cada Cápsula é um mundo privado para apps, credenciais, dados e o trabalho que eles criam juntos.',
      create: 'Nova Cápsula',
      createTitle: 'Criar uma Cápsula',
      createLead: 'Comece com um runtime isolado vazio. Depois instale apps e credenciais dedicadas de Drivers.',
      name: 'Nome da Cápsula',
      placeholder: 'ex.: studio-lab',
      createAction: 'Criar Cápsula',
      creating: 'Criando…',
      cancel: 'Cancelar',
      loading: 'Carregando Cápsulas…',
      count: '{count} no total',
      running: '{count} em execução',
      emptyTitle: 'Seu primeiro mundo começa aqui.',
      emptyLead: 'Crie uma Cápsula vazia e torne-a sua com apps e acesso dedicado a Drivers.',
      needAuthTitle: 'Acesso de Captain necessário',
      needAuthLead: 'Entre no Admin local antes de gerenciar Cápsulas.',
      signIn: 'Abrir login',
      status: 'Runtime',
      identifier: 'ID da Cápsula',
      drivers: 'Drivers dedicados',
      driversLead: 'Credenciais opcionais que pertencem somente a esta Cápsula.',
      destroy: 'Destruir',
      destroyTitle: 'Destruir esta Cápsula?',
      destroyLead: 'Isso remove permanentemente dados, banco, rede, apps e credenciais dedicadas.',
      destroying: 'Destruindo…',
    },
    store: {
      nav: 'Assistants',
      kicker: 'Store de Assistants // canônica',
      title: 'Uma Store. Todas as Cápsulas.',
