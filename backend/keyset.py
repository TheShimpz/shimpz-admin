...
SCHEMA = (
    ...
    },
    {
        ...
        "secret": True,
        "validator": None,
        "help": "Redpanda SASL superuser — generated by the wizard, consumed only by bus-driver.",
    },
    ...
    {
        "key": "IPROYAL_API_TOKEN",
        "group": "proxy",
        "required": False,
        "generate": False,
        "secret": True,
        "validator": None,
        "help": "IPRoyal reseller API token.",
    },
    {
        "key": "IPROYAL_PROXY_IPS",
        "group": "proxy",
        "required": False,
        "generate": False,
        "secret": False,
        "validator": "re:[0-9a-zA-Z.,:-]+",
        "help": "Proxy endpoint IP(s), comma-separated.",
    },
    {
    ...
    {
        "key": "IPROYAL_PROXY_IP",
        "group": "proxy",
        "required": False,
        "generate": False,
        "secret": False,
        "validator": "re:[0-9a-zA-Z.:-]+",
        "help": "Optional: pin ONE proxy IP explicitly (default: first of IPROYAL_PROXY_IPS).",
    },
    {
        "key": "IPROYAL_PROXY_PORT_SOCKS",
        "group": "proxy",
        "required": False,
        "generate": False,
        "secret": False,
    ...
    },
    {
        ...
        "secret": False,
        "validator": None,
        "help": "Proxy mode: auto (default) or off to force-disable.",
    },
    {
        "key": "DOCKER_GID",
        "group": "advanced",
